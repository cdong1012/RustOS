...
fn test_mbr() {
    ...
    //You need to un-archive them first before testing. You can use bin/extract-fat.sh to do that for you.
...
// error tracing documentation:
// shuffle_test
// failing at hash_file_recursive call, failing at entries() call
// apparently next is call infinite ammount of time
// 